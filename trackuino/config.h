...
#define GPS_FIX_R_PIN 7
#define GPS_FIX_G_PIN 8
#define GPS_FIX_B_PIN 6
...
// it is to noise. 
#define APRS_COMMENT    "MercerU Embedded Systems Test"
...
// PWM, so the only two options are pins 9 and 10.
